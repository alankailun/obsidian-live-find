...
export function snippetWindow(source, hitIdx, hitLen, keepShort = false) {
...
export function appendHighlightedSnippet(container, source, hitIdx, hitLen, keepShort = false) {
  if (!source) return;
...
export function ellipsizeMiddle(text, maxLen = 42) {
...
export function pushUniquePart(parts, text, opts = {}) {
...
export function pushMatchedPart(parts, text, hit, opts = {}) {
...
export function buildTableSnippetData(m, lines, matcher, tableLookup) {
